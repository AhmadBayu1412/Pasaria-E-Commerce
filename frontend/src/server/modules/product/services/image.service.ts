...
import {
  ...
  assertOwnership
} from "../rules/image.rules"
import type { AuthenticatedUser } from "../../../shared/session/session.types"
import type { MulterFile } from "../../../shared/types/multer"
import type {
...
} from "../types/image.dto"
import { uploadFileToStorage, deleteFileFromStorage, extractStoragePath } from "../../../infra/storage/supabase"
