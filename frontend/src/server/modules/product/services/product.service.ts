...
import { cacheDelete, cacheDeletePattern, cacheSet, getCache } from "../../../shared/cache/index"
import type { CreateProductInput, UpdateProductInput } from "../validation/product.validation"
import type { PaginationParamsDTO, PaginatedProductResponseDTO, ProductResponseDTO } from "../types/product.dto"
import { assertOwnership, assertUniqueName, assertUniqueNameForUpdate, assertCategoryExists } from "../rules/product.rules"
...
import { queueProductReindex } from "../../../infra/queue/producer"
