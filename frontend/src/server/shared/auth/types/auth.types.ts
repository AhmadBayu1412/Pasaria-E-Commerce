...
import type { UserRole } from "../../../modules/user/types/user.types"

// Re-export untuk方便 module lain import dari sini
export type { UserRole } from "../../../modules/user/types/user.types"
export type { UserDTO } from "../../../modules/user/types/user.types"
export type { CreateUserInput } from "../../../modules/user/types/user.types"
