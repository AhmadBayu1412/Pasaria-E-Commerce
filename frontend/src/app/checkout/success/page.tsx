...
export const metadata: Metadata = {
  title: 'Order Placed Successfully - Pasaria',
...
export default async function CheckoutSuccessRoute({ searchParams }: PageProps) {
      ...
      <div className="container mx-auto px-4 py-16">
        <div className="max-w-lg mx-auto text-center">
          ...
          <p className="text-secondary-600 mb-6">
            Terima kasih telah berbelanja di Pasaria. Pesanan Anda sedang diproses.
          </p>
