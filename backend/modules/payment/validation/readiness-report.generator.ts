...
import { validateArchitecture, type ArchitectureValidation } from './architecture-validation.js';
import { verifyInvariants, type InvariantVerification } from './invariant-verification.js';
